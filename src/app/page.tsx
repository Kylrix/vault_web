            ...
            <Grid container spacing={3}>
              ...
              <Grid size={{ xs: 12, md: 8 }}>
                <Paper sx={{
                  ...
                  <Typography variant="subtitle2" sx={{ fontWeight: 800, mb: 2 }}>Recent Credentials</Typography>
                  {[
                    { name: 'Google', user: 'user@example.com', icon: 'G' },
                    { name: 'GitHub', user: 'dev@kylrix.space', icon: 'GH' },
                    { name: 'Bank', user: '••••••••', icon: 'B' },
                  ].map((item, i) => (
                    <Box key={i} sx={{
                      display: 'flex',
                      alignItems: 'center',
                      ...
                      <Stack direction="row" spacing={2} alignItems="center">
                        ...
                        <Box>
                          ...
                          <Typography variant="caption" sx={{ color: 'rgba(255, 255, 255, 0.5)' }}>{item.user}</Typography>
                        </Box>
                      </Stack>
